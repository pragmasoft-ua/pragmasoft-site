...
** выполняет статисточеские расчеты
...
** Показывает детальную информации о сравнимые маршруты из истории перевозок 
** Показывает статистическое предстазание стоимости перевозки
...
Web UI написно на Angular JS frontend framework and взаимодействетс через REST с backend на Spring MVC framework.   
 
<div class="p-img">

!../../res/img/project/java/Echo_ETL1.png!
!../../res/img/project/java/Echo_ETL2.png!
!../../res/img/project/java/Echo_ETL3.png!
