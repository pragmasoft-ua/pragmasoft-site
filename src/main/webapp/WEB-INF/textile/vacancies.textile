...
# Experience with java development tools - maven, junit, SCM (svn/git/mercurial), IDE, debug, profiling, app servers - deployment
# Not less than 3 years of permanent practical Server side java experience, including:
** Java language and JVM platform, JDK tools
** Java SDK including concurrency, io, nio, networking, collections, classloading, security
